...
import com.rsh.samplemvvvmfilmscatalog.data.api.POSTER_BASE_URL
...
import kotlinx.android.synthetic.main.activity_main.view.progress_bar
import kotlinx.android.synthetic.main.activity_main.view.txt_error
import kotlinx.android.synthetic.main.activity_single_movie.view.*
import kotlinx.android.synthetic.main.movie_list_item.view.*

class PopularMoviewPagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()){
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(getItemViewType(position) == MOVIE_VIEW_TYPE){
            ...
            (holder as NetworkSateItemViewHolder).bind(networkState)
        }
    }
